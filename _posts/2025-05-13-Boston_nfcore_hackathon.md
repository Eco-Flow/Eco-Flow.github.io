---
title: 'nf-core hackathon Boston'
date: 2025-05-13
...
<img align="top" width="" src="/img/nfboston.png" />
...
**Quality control modules**: Implementing robust filtering and QC steps for genotype data
**Visualization**: Adding Manhattan plots and QQ plots for results interpretation
**Documentation**: Writing user guides and parameter descriptions
...
We're committed to continuing our contributions to nf-core/gwas and hope to see it reach a stable v1.0 release soon. The collaborative spirit of the nf-core hackathon was inspiring, and we're grateful for the opportunity to contribute to open-source bioinformatics infrastructure.
If you're interested in GWAS analysis or want to contribute to the pipeline, check out the GitHub repository and join the discussion in Slack!
